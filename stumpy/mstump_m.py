...
def _compute_PI(d, idx, D, D_prime, range_start, P, I, m, p=2.0):
    """
...
def _mstump(
    ...
    for idx in range(range_start, range_stop): ### CHANGE HERE step of m length
        _compute_multi_D(
            d,
            k,
            idx,
...
def mstump_m(T, m, include=None, discords=False, normalize=True, p=2.0):
    """
